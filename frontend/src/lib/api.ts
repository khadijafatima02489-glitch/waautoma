...
export interface WhatsAppConfig { provider: string; status: string; connected_number?: string; logs: string[]; evolution?: { evolution_api_url: string; evolution_api_key_masked: string; evolution_instance_name: string }; meta?: { webhook_url: string; configured: boolean; meta_phone_number_id: string; meta_waba_id: string; meta_access_token_masked: string; meta_verify_token: string }; evolution_webhook_url?: string; qr_code?: string | null; detail?: string }
